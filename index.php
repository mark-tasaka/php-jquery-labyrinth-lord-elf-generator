...
<html>
<head>
<title>Launch Page: Labyrinth Lord Elf Generator</title>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#elfForm").attr('action', "character/ll_elf_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
