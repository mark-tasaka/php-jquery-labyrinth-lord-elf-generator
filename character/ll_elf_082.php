...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
       ...
       <span id="elfTrait4">Ability to speak the Common tongue, Elvish, <?php echo $alignment; ?> Alignment<br/> tongue, Gnoll, Hobgoblin and Orc.</span>
  ...
  <script>
	...
	*/
	function Character() {
        ...
        let	intelligence = rollDice(10, 3, 2, 8);
